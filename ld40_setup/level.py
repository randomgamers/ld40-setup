...
class Level3(Level):
    def __init__(self):
        ...
        self.hostages = [
            ...
            hostages.FatGuy(position=(14, 15), player=self.player, entry_tile=self.entry_coord, end_tiles=self.end_coords),
            hostages.RegularGuy(position=(15, 15), player=self.player, entry_tile=self.entry_coord, end_tiles=self.end_coords),
            hostages.NoisyChick(position=(16, 15), player=self.player, entry_tile=self.entry_coord, end_tiles=self.end_coords),
            ...
            hostages.FatGuy(position=(19, 15), player=self.player, entry_tile=self.entry_coord, end_tiles=self.end_coords),
